...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 glass-panel border-r border-slate-800/80 flex flex-col h-screen select-none transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${
        ...
        <div className="p-4 sm:p-5 border-b border-slate-800/60 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 font-medium truncate max-w-[120px]">
